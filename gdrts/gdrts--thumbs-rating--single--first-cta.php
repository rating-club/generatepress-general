<?php // GDRTS Template: GeneratePress with CTA // ?>

<div class="<?php gdrts_loop()->render()->classes( 'gdrts-first-cta' ); ?>">
    <div class="gdrts-inner-wrapper">

		<?php do_action( 'gdrts-template-rating-block-before' ); ?>

		<?php gdrts_loop()->render()->call_to_action(); ?>

		<?php gdrts_loop()->render()->thumbs(); ?>
